 ...
 * 
 * INtime:
 * After you build up the rta file, 
 * you can start the application with command line. 
 * such as:
 *			ldrta .\slaveinfo.rta -a "ie1g0 -sdo"
 * Check: http://support.tenasys.com/INtimeHelp_62/#util_ldrta.html
 */
